...
import { GraduationCap, Mail, ArrowLeft, BookMarked, Loader2, AlertCircle, Settings, Users, BarChart3 } from "lucide-react";
          ...
          <FadeIn className="w-full max-w-md">
            ...
            <div className="glass-deep rounded-2xl shadow-card-hover p-8 card-hover-glow">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-role-coordinator text-white font-medium hover:opacity-90 hover:-translate-y-0.5 transition-all btn-glow"
