...
const PrincipalLogin = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Left panel - Branding */}
      <div className="hidden md:flex md:w-1/2 bg-role-principal relative overflow-hidden items-center justify-center p-12">
      ...
      <div className="flex-1 flex flex-col bg-background">
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <FadeIn className="w-full max-w-md">
            ...
            <div>
              <div className="mb-8">
                <div className="w-14 h-14 bg-role-principal rounded-xl flex items-center justify-center mb-4 md:hidden">
