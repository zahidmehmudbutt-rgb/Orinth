...
const PrincipalLogin = () => {
    ...
    try {
      ...
      if (!isPrincipal) {
        ...
        toast({
          variant: "destructive",
          title: "Access Denied",
          description: "This account does not have Principal access. Please use the correct login portal for your role.",
        });
        setIsLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-role-principal relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white max-w-md">
          <FadeIn delay={0.2}>
            ...
            <h1 className="text-4xl font-bold mb-4">Principal Portal</h1>
            <p className="text-lg opacity-90 mb-8">
              Full oversight of school administration, analytics, and strategic management.
            </p>
      ...
      <div className="flex-1 flex flex-col bg-background">
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <FadeIn className="w-full max-w-md">
            ...
            <div>
              <div className="mb-8">
                <div className="w-14 h-14 bg-role-principal rounded-xl flex items-center justify-center mb-4 lg:hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-role-principal text-white font-medium hover:opacity-90"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
