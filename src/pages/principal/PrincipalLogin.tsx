...
import { GraduationCap, Mail, ArrowLeft, Crown, Loader2, AlertCircle, BarChart3, Shield, Building } from "lucide-react";
...
const PrincipalLogin = () => {
  ...
  const demo = DEMO_CREDENTIALS.principal;
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <Helmet><title>Principal Login — School Management System</title></Helmet>
      {/* Left panel - Branding */}
