...
import { GraduationCap, Mail, Lock, ArrowLeft, BookOpen, Loader2, AlertCircle } from "lucide-react";
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="bg-card rounded-2xl shadow-card-hover p-8 border border-border">
            <div className="text-center mb-8">
              <div className="w-16 h-16 bg-role-teacher rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-role-teacher text-primary-foreground font-medium hover:opacity-90"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
