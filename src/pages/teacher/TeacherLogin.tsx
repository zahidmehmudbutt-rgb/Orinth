...
import { GraduationCap, Mail, Lock, ArrowLeft, BookOpen, Loader2, AlertCircle, Users, ClipboardCheck, FileText, Eye, EyeOff } from "lucide-react";
...
const TeacherLogin = () => {
    ...
    try {
      ...
      if (!isTeacher) {
        ...
        toast({
          ...
          description: t("login.noTeacherAccess"),
        });
        setIsLoading(false);
        return;
      }
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <Helmet><title>Teacher Login — School Smart Pakistan</title></Helmet>
      {/* Left panel - Branding */}
          ...
          <FadeIn className="w-full max-w-md">
            ...
            <div className="bg-card/80 dark:bg-card/70 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-white/[0.08] shadow-card-hover p-8">
              <div className="mb-8">
                ...
                <h2 className="text-2xl font-extrabold text-foreground">{t("login.teacherLogin")}</h2>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 pr-12 h-12 bg-background/50 dark:bg-background/30 ${passwordError ? 'border-destructive focus-visible:ring-destructive' : ''}`}
                      disabled={isLoading}
