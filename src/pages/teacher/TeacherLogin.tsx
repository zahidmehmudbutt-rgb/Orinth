...
const TeacherLogin = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left panel - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-role-teacher relative overflow-hidden items-center justify-center p-12">
          ...
          <FadeIn delay={0.2}>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-sm opacity-80">
                ...
                <span>Upload homework & materials</span>
              </div>
              <div className="flex items-center gap-3 text-sm opacity-80">
                <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
                  <ClipboardCheck className="w-4 h-4" />
                </div>
                <span>Enter marks & assessments</span>
              </div>
              <div className="flex items-center gap-3 text-sm opacity-80">
                <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
      ...
      <div className="flex-1 flex flex-col bg-background">
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <FadeIn className="w-full max-w-md">
            ...
            <div>
              <div className="mb-8">
                <div className="w-14 h-14 bg-role-teacher rounded-xl flex items-center justify-center mb-4 lg:hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-role-teacher text-white font-medium hover:opacity-90"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
